...
import {TERC20, MockTERC20} from "src/MockTERC20.sol";
...
contract ERC20Test is SoladyTest {
    ...
    function setUp() public {
        token = new MockTERC20("Token", "TKN", 18);
    }
    ...
    function testMintOverMaxUintReverts() public {
        ...
        vm.expectRevert(TERC20.TotalSupplyOverflow.selector);
        token.mint(address(this), 1);
    }

    function testTransferInsufficientBalanceReverts() public {
        token.mint(address(this), 0.9e18);
        vm.expectRevert(TERC20.InsufficientBalance.selector);
    ...
    function testTransferFromInsufficientAllowanceReverts() public {
        ...
        vm.expectRevert(TERC20.InsufficientAllowance.selector);
    ...
    function testPermitBadNonceReverts(uint256) public {
        ...
        vm.expectRevert(TERC20.InvalidPermit.selector);
        _permit(t);
    }
    ...
    function testPermitPastDeadlineReverts(uint256) public {
        ...
        vm.expectRevert(TERC20.PermitExpired.selector);
        _permit(t);
    }
